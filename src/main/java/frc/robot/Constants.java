...
public final class Constants {
  ...
  public static class AprilTags {
    ...
    public static final List<AprilTag> APRIL_TAGS = List.of(
        ...
        new AprilTag(2,
            new Pose3d(new Translation3d(657.37, 291.20, 58.50), new Rotation3d(0, 0, Math.toRadians(234)))),
        new AprilTag(3,
            new Pose3d(new Translation3d(455.15, 317.15, 51.25), new Rotation3d(0, 0, Math.toRadians(270)))),
        ...
        new AprilTag(6,
            new Pose3d(new Translation3d(530.49, 130.17, 12.13), new Rotation3d(0, 0, Math.toRadians(300)))),
        ...
        new AprilTag(9,
            new Pose3d(new Translation3d(497.77, 186.83, 12.13), new Rotation3d(0, 0, Math.toRadians(120)))),
        new AprilTag(10,
            new Pose3d(new Translation3d(481.39, 158.50, 12.13), new Rotation3d(0, 0, Math.toRadians(180)))),
        new AprilTag(11,
            new Pose3d(new Translation3d(497.77, 130.17, 12.13), new Rotation3d(0, 0, Math.toRadians(240)))),
        new AprilTag(12, new Pose3d(new Translation3d(33.51, 25.80, 58.50), new Rotation3d(0, 0, Math.toRadians(54)))),
        new AprilTag(13,
            new Pose3d(new Translation3d(33.51, 291.20, 58.50), new Rotation3d(0, 0, Math.toRadians(306)))),
        new AprilTag(14,
            new Pose3d(new Translation3d(325.68, 241.64, 73.54),
                new Rotation3d(Math.toRadians(30), 0, Math.toRadians(180)))),
        new AprilTag(15,
            new Pose3d(new Translation3d(325.68, 75.39, 73.54),
                new Rotation3d(Math.toRadians(30), 0, Math.toRadians(180)))),
        ...
        new AprilTag(18,
            new Pose3d(new Translation3d(144.00, 158.50, 12.13), new Rotation3d(0, 0, Math.toRadians(180)))),
        new AprilTag(19,
            new Pose3d(new Translation3d(160.39, 186.83, 12.13), new Rotation3d(0, 0, Math.toRadians(120)))),
        new AprilTag(20,
            new Pose3d(new Translation3d(193.10, 186.83, 12.13), new Rotation3d(0, 0, Math.toRadians(60)))),
        new AprilTag(21, new Pose3d(new Translation3d(209.49, 158.50, 12.13), new Rotation3d(0, 0, 0))),
        new AprilTag(22,
            new Pose3d(new Translation3d(193.10, 130.17, 12.13), new Rotation3d(0, 0, Math.toRadians(300)))));
  }
  ...
  public static class Intake {
    ...
    public static double kCoralIntakeSpeed = -0.3;
    public static double kReefDeliverySpeed = -1.0;
    public static double kTroughDeliverySpeed = -0.5;
    public static int kAlgaeMotorCANId = 40;
  }

  public static class Bindings {
    public static double triggerDownThreshhold = 0.3;
  }
  ...
  public static class Elevator {
    ...
    // Digital Input of Lower Sensor
    public static int kLowerLimitInput = 0;
    ...
    public static class Heights {
      ...
      public static double kL4 = kL3 + 0.46;

      public static final double[] ReefLevel = {kL1,kL2,kL3,kL4};
  ...
  public static class Climber {
    public static int kClimberMotorCANID = 61;
    public static double kClimberSpeed = 0.2;
  }
